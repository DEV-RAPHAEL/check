  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      ...
      <div class="col-8 text-right">
        <a data-toggle="modal" data-target="#donation-page" href="" class="btn btn-sm btn-neutral"><i class="fad fa-plus"></i> {{__('Create Payment Link')}}</a> 
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">   
                    ...
                    <div class="form-group row">
                      <div class="col-lg-12">
                        <div class="custom-file">
                          ...
                          <span class="form-text text-xs">Recommended Image Size is 640x360</span>
                        </div> 
                      </div>    
                    </div>    
                    <div class="form-group row">
                ...
                <div class="card">
                  ...
                  @endphp
                    <div class="card-body">
                      <div class="row mb-2">
                        <div class="col-4">
                          <p class="text-sm text-dark mb-2"><a class="btn-icon-clipboard" data-clipboard-text="{{route('dpview.link', ['id' => $val->ref_id])}}" title="Copy">{{__('COPY LINK')}} <i class="fad fa-link text-xs"></i></a></p>
                        </div>
                        <div class="col-8 text-right">
                          ...
                          <div class="dropdown-menu dropdown-menu-left">
                            @if($val->active==1)
                                <a class='dropdown-item' href="{{route('dplinks.unpublish', ['id' => $val->id])}}"><i class="fad fa-ban"></i>{{ __('Disable')}}</a>
                            @else
                                <a class='dropdown-item' href="{{route('dplinks.publish', ['id' => $val->id])}}"><i class="fad fa-check"></i>{{ __('Activate')}}</a>
                            @endif
                            <a class="dropdown-item" href="{{route('user.sclinkstrans', ['id' => $val->id])}}"><i class="fad fa-sync"></i>{{__('Transactions')}}</a>
                            <a class="dropdown-item" data-toggle="modal" data-target="#donors{{$val->id}}" href="#"><i class="fad fa-user"></i>{{__('Donors')}}</a>
                      ...
                      <div class="row mb-3">
                        <div class="col-12">
                          ...
                          <p>{{__('Amount')}}: {{$currency->symbol.number_format($donated, 2, '.', '')}}/{{$currency->symbol.number_format($val->amount, 2, '.', '')}}</p>
